...
if len(espacios_grandes_mail) > 0:
    ...
    # Umbral más estricto: usar el máximo como referencia
    umbral_palabra_mail = espacio_promedio_mail * 3.0
    ...
    print(f"Espacio promedio: {espacio_promedio_mail:.2f}, Espacio máximo: {espacio_maximo_mail}, Umbral: {umbral_palabra_mail:.2f}")
else:
...
if validacion_nombre_ok and validacion_edad_ok and validacion_mail_ok and validacion_legajo_ok and validacion_pregunta1_ok and validacion_pregunta2_ok and validacion_pregunta3_ok:
